...
`Create internal reasons-to-connect notes that explain why another consultant, practice, team, or asset may help with a specific client situation.`
...
- the best note explains why this client, why now, why this consultant or capability, what evidence supports it, and what safe next step is suggested

## Draft Manifest Copy

`Reasons to Connect helps teams turn account, service, partner, industry, AI, automation, and external-trigger signals into internal recommendations for involving the right consultant, practice, team, or asset at the right moment.`

`The guided setup captures where the recommendation will land, what signal triggered it, who owns the relationship, what needs validation, and what evidence makes the connection useful without sounding like crude cross-selling.`
